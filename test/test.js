...
const { JSDOM } = jsdom;
let dom = new JSDOM('<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>Document</title>' +
                    '</head><body><div class="plegable"></div><div id="divToLeft"></div><div id="divToRight"></div>' +
                    '</body></html>');
